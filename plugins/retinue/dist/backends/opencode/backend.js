...
const DEFAULT_INCOMPLETE_ASSISTANT_STALL_MS = 75_000;
const DEFAULT_SERVER_IDLE_MS = 30_000;
const DEFAULT_BLANK_ASSISTANT_STALL_MS = 75_000;
const DEFAULT_ZERO_PROGRESS_ASSISTANT_STALL_MS = 75_000;
...
export class OpenCodeBackend {
    ...
    async maybeSubmitSoftStallRescue(meta, diagnostic) {
        ...
        const updated = { ...meta, externalRescuePromptSubmittedAt: new Date().toISOString(), updatedAt: new Date().toISOString() };
