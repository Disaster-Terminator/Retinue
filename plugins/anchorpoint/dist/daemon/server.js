...
export function createDaemonServer(supervisor, options = {}) {
    const maxBodyBytes = options.maxBodyBytes ?? 1024 * 1024;
    const routes = new Map([
        ["POST /v1/jobs/run", (body) => supervisor.run(body)],
        ...
        ["POST /v1/jobs/continue", (body) => supervisor.continueJob(body)],
        ...
        ["POST /v1/jobs/cleanup", (body) => supervisor.cleanup((body ?? {}))]
    ]);
