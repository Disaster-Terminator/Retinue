import type { CleanupOptions, CleanupResult, ContinueOptions, JobMeta, JobResult, JobStatusResult, KillResult, PeekOptions, PeekResult, RunOptions, SupervisorApi, SupervisorOptions, WaitOptions, WaitResult } from "./types.js";
export declare class ClaudeSupervisor implements SupervisorApi {
