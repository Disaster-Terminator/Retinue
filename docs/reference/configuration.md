...
| `RETINUE_OPENCODE_TASK_ATTEMPT_MAX` | reason-specific default | Maximum fresh task attempts after recoverable OpenCode stalls. If unset, malformed tool-call stalls default to 2 attempts and other recoverable stalls default to 1. Set `0` to disable. |
